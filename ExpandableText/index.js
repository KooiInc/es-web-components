...
function getStyling() {
  ...
  .expand-title [data-is-expanded='0'] ~ .expand-content {
    max-height: 0;
    max-width: 40vw;
    color: #c0c0c0;
    padding: 0;
